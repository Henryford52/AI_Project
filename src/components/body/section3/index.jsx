...
const Section3 = () => {
  ...
  return (
    <div className='Section3'>
      ...
      <button className='btn' data-aos='fade-up' data-aos-easing= 'ease-out-cubic' data-aos-duration = ''>Join Now</button>
    </div>
  )
}
